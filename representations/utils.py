...
PRINCETON = 'scharfsinnig, Soeldner, fleissig, habgierig, intelligent, ehrgeizig, schlau, loyal, hartnaeckig, gespraechig ,\
aggressiv, religioes, materialistisch, praktisch'.lower().split(', ')
